...
export const Mecury: Planet = {
  ...
  name: 'Mercury',
  planet: {
    text: "Mercury is the smallest planet in the Solar System and the closest to the Sun. It's orbit around the Sun takes 87.97 mars days, the shortest of all the Suns planets. Mercury is one of four terrestrial planets in the Solar System, and is a rocky body like Earth.",
    link: 'https://pt.wikipedia.org/wiki/Merc%C3%BArio_(planeta)'
  },
  internal: {
    text: "Mercury appears to have a solid silicate crust and mantle overlying a solid, iron sulfide outer core layer, a deeper liquid core layer, and a solid inner core. The planets density is the second highest in the Solar System at 5.427 g/cm3 , only slightly less than Earth's density.",
    link: 'https://pt.wikipedia.org/wiki/Merc%C3%BArio_(planeta)#Estrutura_interna'
  },
  geology: {
    ...
    link: 'https://pt.wikipedia.org/wiki/Merc%C3%BArio_(planeta)#Geologia_da_superf%C3%ADcie'
  },
  imagePlanet: mercury,
...
export const Venus: Planet = {
  ...
  internal: {
    ...
    link: 'https://pt.wikipedia.org/wiki/V%C3%A9nus_(planeta)#Estrutura_interna'
  },
  geology: {
    ...
    link: 'https://pt.wikipedia.org/wiki/V%C3%A9nus_(planeta)#Geografia'
  },
  imagePlanet: venus,
...
export const Earth: Planet = {
  ...
  internal: {
    ...
    link: 'https://pt.wikipedia.org/wiki/Terra#Composi%C3%A7%C3%A3o_e_estrutura'
  },
  geology: {
...
export const Mars: Planet = {
  ...
  internal: {
    ...
    link: 'https://pt.wikipedia.org/wiki/Marte_(planeta)#Estrutura_interna'
  },
  geology: {
    ...
    link: 'https://pt.wikipedia.org/wiki/Marte_(planeta)#Geologia_da_superf%C3%ADcie'
  },
  imagePlanet: mars,
...
export const Jupiter: Planet = {
  ...
  internal: {
    ...
    link: 'https://pt.wikipedia.org/wiki/J%C3%BApiter_(planeta)#Estrutura_interna'
  },
  geology: {
    ...
    link: 'https://pt.wikipedia.org/wiki/J%C3%BApiter_(planeta)#Atmosfera'
  },
  imagePlanet: jupiter,
...
export const Saturn: Planet = {
  ...
  internal: {
    ...
    link: 'https://pt.wikipedia.org/wiki/Saturno_(planeta)#Estrutura_interna'
  },
  geology: {
    ...
    link: 'https://pt.wikipedia.org/wiki/Saturno_(planeta)#Atmosfera'
  },
  imagePlanet: saturn,
...
export const Uranus: Planet = {
  ...
  internal: {
    ...
    link: 'https://pt.wikipedia.org/wiki/Urano_(planeta)#Estrutura_interna'
  },
  geology: {
    ...
    link: 'https://pt.wikipedia.org/wiki/Urano_(planeta)#Atmosfera'
  },
  imagePlanet: uranus,
...
export const Neptune: Planet = {
  ...
  internal: {
    ...
    link: 'https://pt.wikipedia.org/wiki/Netuno_(planeta)#Estrutura_interna'
  },
  geology: {
    ...
    link: 'https://pt.wikipedia.org/wiki/Netuno_(planeta)#Atmosfera'
  },
  imagePlanet: neptune,
